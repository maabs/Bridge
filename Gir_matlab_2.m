...
alpha=0.5;
particleCount = 10;
iterCount = 1200; % replicates count
...
writematrix(h1_flat, 'Observationsdata_matlab/Grads1_sm_28.txt');
writematrix(X1_flat, 'Observationsdata_matlab/X1_sm_28.txt');
writematrix(h2_flat, 'Observationsdata_matlab/Grads2_sm_28.txt');
writematrix(X2_flat, 'Observationsdata_matlab/X2_sm_28.txt');
writematrix(thetas_flat, 'Observationsdata_matlab/thetas_sm_28.txt');
writematrix(thetas_p_level,'Observationsdata_matlab/thetas_p_level_28.txt');
